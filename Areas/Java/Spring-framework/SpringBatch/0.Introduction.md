...
# **Spring Batch: 대량 데이터 처리의 A to Z**
...
- **커서(Cursor) vs 페이징(Paging)**: 데이터베이스에서 데이터를 읽어오는 두 가지 주요 방식입니다.
    - **커서 방식**: 한 번에 소량의 데이터만 메모리에 올리고 커서로 다음 데이터를 가리킨다. 메모리 효율이 높아 매우 큰 데이터셋에 적합합니다.
        
    - **페이징 방식**: 청크 단위(페이지)로 데이터를 한꺼번에 가져온다. 일반적으로 커서보다 빠르나 더 많은 메모리를 사용한다.
...
![[Pasted image 20250923155020.png]]

## **Job**
---
### **Job**

![[Pasted image 20250923154950.png]]
...
![[Pasted image 20250923154828.png]]
...
![[Pasted image 20250923154848.png]]
...
![[Pasted image 20250923154910.png]]
